...
if __name__ == "__main__":
    ...
    # env.noise, env.slope = 1.0, -0.5
    envs = [8, 34]
    
    env = BipedalWalker(envs=envs, render_mode="human", hardcore=False)
    max_steps = 1600
    net = NeuralNetwork(24, 20, 4)

    load_path = "generalist-controllers-terrain\XNES_Biped\Experiment_Results\Results_Biped_best.pt"
